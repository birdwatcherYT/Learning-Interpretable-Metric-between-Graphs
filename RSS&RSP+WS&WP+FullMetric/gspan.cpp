...
namespace GSPAN {
    ...
    void gSpan::run(const vecVec &active_Xt, const vecVec &test_Xt, const vector<double>& m, double lambda, double L, double U, double eta, double eps, unsigned loopMax) {
