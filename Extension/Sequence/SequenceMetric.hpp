#ifndef SEQUENCEMETRIC_HPP
#define SEQUENCEMETRIC_HPP
...
public:
    SequenceMetric(const std::string& filename, int minsup, int maxpat, double train, int Ksample);
